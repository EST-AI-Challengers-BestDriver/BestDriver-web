...
def predict_route_energy(
    ...
    summary.to_csv(result_dir / "route_energy_summary.csv", index=False, encoding="utf-8-sig")
    segments.to_csv(result_dir / "segment_energy_predictions.csv", index=False, encoding="utf-8-sig")
    route_features = []
